    ...
    >
      <div className="p-6 flex-shrink-0">
        <div className="flex items-center space-x-3 mb-8 group animate-fade-in">
          ...
          <h1 className="text-2xl font-bold tracking-tight">ProjectFund</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6 custom-scrollbar">
        <nav className="space-y-1.5" aria-label="Primary navigation">
          ...
          >
            <div className="flex items-center space-x-3">
              <TrendingUp size={20} aria-hidden="true" className={isActive('/') ? 'text-white' : 'text-white/80'} />
          ...
          >
            <div className="flex items-center space-x-3">
              <Folder size={20} aria-hidden="true" className={isActive('/projects') ? 'text-white' : 'text-white/80'} />
          ...
          {canAccessFundAllocation() && (
            ...
            >
              <div className="flex items-center space-x-3">
                <Coins size={20} aria-hidden="true" className={isActive('/allocations') ? 'text-white' : 'text-white/80'} />
          ...
          <ProtectedComponent requiredPermission="canAccessCostEntry">
            ...
            >
              <div className="flex items-center space-x-3">
                <Calculator size={20} aria-hidden="true" className={isActive('/cost-entry') ? 'text-white' : 'text-white/80'} />
          ...
          <ProtectedComponent requiredPermission="canAccessCostEntry">
            ...
            >
              <div className="flex items-center space-x-3">
                <Banknote size={20} aria-hidden="true" className={isActive('/revenue-entry') ? 'text-white' : 'text-white/80'} />
          ...
          >
            <div className="flex items-center space-x-3">
              <ClipboardList size={20} aria-hidden="true" className={isActive('/project-costings') ? 'text-white' : 'text-white/80'} />
          ...
          >
            <div className="flex items-center space-x-3">
              <Receipt size={20} aria-hidden="true" className={isActive('/transactions') ? 'text-white' : 'text-white/80'} />
          ...
          >
            <div className="flex items-center space-x-3">
              <BarChart3 size={20} aria-hidden="true" className={isActive('/analytics') ? 'text-white' : 'text-white/80'} />
          ...
          >
            <div className="flex items-center space-x-3">
              <ClipboardList size={20} aria-hidden="true" className={isActive('/audit') ? 'text-white' : 'text-white/80'} />
        ...
        <div className="mt-6 pt-6 border-t border-white/20">
          <h3 className="text-xs font-bold uppercase tracking-wider opacity-60 mb-3 px-3">Configuration</h3>
          <nav className="space-y-1.5" aria-label="Configuration">
            ...
            >
              <div className="flex items-center space-x-3">
                <List size={20} aria-hidden="true" className={isActive('/line-items') ? 'text-white' : 'text-white/80'} />
            ...
            >
              <div className="flex items-center space-x-3">
                <Package size={20} aria-hidden="true" className={isActive('/materials') ? 'text-white' : 'text-white/80'} />
        ...
        <ProtectedComponent requiredPermission="canAccessUserManagement">
          <div className="mt-6 pt-6 border-t border-white/20">
            <h3 className="text-xs font-bold uppercase tracking-wider opacity-60 mb-3 px-3">Management</h3>
            <nav className="space-y-1.5" aria-label="Management">
              <ProtectedComponent requiredPermission="canViewTeams">
                ...
                >
                  <div className="flex items-center space-x-3">
                    <Network size={20} aria-hidden="true" className={isActive('/teams') ? 'text-white' : 'text-white/80'} />
              ...
              >
                <div className="flex items-center space-x-3">
                  <Users size={20} aria-hidden="true" className={isActive('/users') ? 'text-white' : 'text-white/80'} />
              ...
              <ProtectedComponent requiredPermission="canAccessPermissions">
                ...
                >
                  <div className="flex items-center space-x-3">
                    <Shield size={20} aria-hidden="true" className={isActive('/permissions') ? 'text-white' : 'text-white/80'} />
        ...
        <ProtectedComponent requiredPermission="canAccessCompanyManagement">
          <div className="mt-6 pt-6 border-t border-white/20">
            <h3 className="text-xs font-bold uppercase tracking-wider opacity-60 mb-3 px-3">Console Management</h3>
            <nav className="space-y-1.5" aria-label="Console Management">
              ...
              >
                <div className="flex items-center space-x-3">
                  <Building2 size={20} aria-hidden="true" className={isActive('/companies') ? 'text-white' : 'text-white/80'} />
